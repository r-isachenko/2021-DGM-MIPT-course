...
\begin{frame}{Spectral Normalization GAN}
	...
	\begin{itemize}
		\item $a_k$ is a pointwise nonlinearities. We assume that $\| \sigma_k \|_L = 1$ (it holds for ReLU).
...
\begin{frame}{Evaluation of likelihood-free models}
	...
	\begin{block}{Frechet Inception Distance}
		\vspace{-0.3cm}
		\[
			FID (\pi, p) = \| \mathbf{m}_{\pi} - \mathbf{m}_{p}\|_2^2 + \text{Tr} \left( \bC_{\pi} + \bC_p - 2 \sqrt{\bC_{\pi} \bC_p} \right)
		\]
		\vspace{-0.5cm}
	\end{block}
	\begin{itemize}
...
\begin{frame}{Limitations}
	...
	\begin{block}{Frechet Inception Distance}
		\vspace{-0.4cm}
		\[
			FID = \| \mathbf{m}_{\pi} - \mathbf{m}_{p}\|_2^2 + \text{Tr} \left( \bC_{\pi} + \bC_p - 2 \sqrt{\bC_{\pi} \bC_p} \right)
		\]
		\vspace{-0.7cm}
	\end{block}
	\begin{itemize}
