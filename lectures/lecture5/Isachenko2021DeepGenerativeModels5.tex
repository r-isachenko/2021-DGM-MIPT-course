...
\begin{frame}{Gaussian autoregressive model}
	...
	\begin{block}{Inverse transform}
		...
		\vspace{-0.3cm}
	\end{block}
	We have got an autoregressive flow with base distribution $\bz = \cN(0, 1)$ and affine coupling law $\tau(x, \mu, \sigma) = x \odot \mu + \sigma$.
...
\begin{frame}{Linear flows}
	...
	\item Stacking layers we should \textbf{permute} components.
	\end{itemize}
	\[
