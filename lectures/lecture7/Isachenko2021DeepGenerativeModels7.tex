...
\begin{frame}{ELBO surgery}
	...
	\begin{itemize}
		...
		\vspace{0.1cm}
		\item Parametrized distribution $p(\bz | \blambda)$;
...
\begin{frame}{VampPrior}
	...
	\item Is it beneficial to couple the prior with the variational posterior or it is enough to parametrize the prior?
	\end{itemize}
	\begin{block}{Results}
		\vspace{-0.3cm}
...
\end{frame}
%=======
\begin{frame}{Flows in VAE prior}
